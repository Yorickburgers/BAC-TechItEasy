        ...
        http
                ...
                .authorizeHttpRequests(auth ->
                        auth
                                ...
                                .requestMatchers(HttpMethod.GET,"/ci-modules/**").authenticated()
                                .requestMatchers("/ci-modules/**").hasRole("ADMIN")
                                .requestMatchers(HttpMethod.GET,"/wall-brackets/**").authenticated()
                                .requestMatchers("/wall-brackets/**").hasRole("ADMIN")
                                .requestMatchers(HttpMethod.GET,"/remotes/**").authenticated()
                                .requestMatchers("/remotes/**").hasRole("ADMIN")
